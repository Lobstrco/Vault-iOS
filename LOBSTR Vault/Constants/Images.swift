...
internal enum Asset {
  ...
  internal enum Icons {
    ...
    internal enum Other {
      ...
      internal static let icAdd = ImageAsset(name: "Icons/Other/icAdd")
      internal static let icAlert = ImageAsset(name: "Icons/Other/icAlert")
      internal static let icArrow = ImageAsset(name: "Icons/Other/icArrow")
      internal static let icCheckboxActive = ImageAsset(name: "Icons/Other/icCheckboxActive")
      internal static let icCheckboxPassive = ImageAsset(name: "Icons/Other/icCheckboxPassive")
      ...
      internal static let icGrabAndPull = ImageAsset(name: "Icons/Other/icGrabAndPull")
      ...
      internal static let icPasteFromClipboard = ImageAsset(name: "Icons/Other/icPasteFromClipboard")
      ...
      internal static let icTrash = ImageAsset(name: "Icons/Other/icTrash")
    }
